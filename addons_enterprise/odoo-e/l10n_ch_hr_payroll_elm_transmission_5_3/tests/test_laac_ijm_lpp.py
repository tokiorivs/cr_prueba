...
class TestSwissdecCommon(TestSwissdecMinorCommon):
    ...
    def test_03_lpp_in_percentage(self):
        slips = self._l10n_ch_create_batch(self.muster_ag_company, 1).slip_ids
        self.assertEqual(slips[0].line_ids.filtered(lambda l: l.code == "LPPSALARY").total, 7560, 2)
        self.assertAlmostEqual(slips[0].line_ids.filtered(lambda l: l.code == "PP.PERCENTAGE").total, -790, 2)
        self.assertAlmostEqual(slips[0].line_ids.filtered(lambda l: l.code == "PP.PERCENTAGE.COMP").total, 955.8, 2)

        self.assertEqual(slips[1].line_ids.filtered(lambda l: l.code == "LPPSALARY").total, 7560, 2)
        self.assertAlmostEqual(slips[1].line_ids.filtered(lambda l: l.code == "PP.PERCENTAGE").total, -689.8, 2)
        self.assertAlmostEqual(slips[1].line_ids.filtered(lambda l: l.code == "PP.PERCENTAGE.COMP").total, 351, 2)
    ...
    def test_04_lpp_negative_avs_salary(self):
        ...
        self.assertEqual(slips[0].line_ids.filtered(lambda l: l.code == "LPPSALARY").total, 7560.0, 2)
        self.assertAlmostEqual(slips[0].line_ids.filtered(lambda l: l.code == "PP.PERCENTAGE").total, -790, 2)
        self.assertAlmostEqual(slips[0].line_ids.filtered(lambda l: l.code == "PP.PERCENTAGE.COMP").total, 955.8, 2)

        self.assertEqual(slips[1].line_ids.filtered(lambda l: l.code == "AVSSALARY").total, -20000, 2)
        self.assertEqual(slips[1].line_ids.filtered(lambda l: l.code == "LPPSALARY").total, 7560.0, 2)
        self.assertAlmostEqual(slips[1].line_ids.filtered(lambda l: l.code == "PP.PERCENTAGE").total, -689.8, 2)
        self.assertAlmostEqual(slips[1].line_ids.filtered(lambda l: l.code == "PP.PERCENTAGE.COMP").total, 351, 2)
    ...
    def test_05_lpp_lower_than_coordination(self):
        ...
        self.assertEqual(slips[0].line_ids.filtered(lambda l: l.code == "LPPSALARY").total, 295, 2)
        self.assertAlmostEqual(slips[0].line_ids.filtered(lambda l: l.code == "PP.PERCENTAGE").total, -30.85, 2)
        self.assertAlmostEqual(slips[0].line_ids.filtered(lambda l: l.code == "PP.PERCENTAGE.COMP").total, 37.30, 2)

        self.assertEqual(slips[1].line_ids.filtered(lambda l: l.code == "AVSSALARY").total, 2500, 2)
        self.assertEqual(slips[1].line_ids.filtered(lambda l: l.code == "LPPSALARY").total, 295, 2)
        self.assertAlmostEqual(slips[1].line_ids.filtered(lambda l: l.code == "PP.PERCENTAGE").total, -26.90, 2)
        self.assertAlmostEqual(slips[1].line_ids.filtered(lambda l: l.code == "PP.PERCENTAGE.COMP").total, 13.70, 2)
